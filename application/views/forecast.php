                            ...
                            <div class="col" >
                                <section class="card">
                                    <header class="card-header">
                                        ...
                                        <h2 class="card-title" style="color: black;">Forecast 2018</h2>
...
<?php $this->load->helper('form');?>
   <?php echo form_open('Welcome/forecast'); ?>                      
  <div class="row"> 
...
tbody tr {
  ...
  table-layout:fixed;
      ...
      <table class="table table-responsive-lg table-bordered table-striped table-sm mb-0">
          <thead>
      <tr>
      <th  style="width:5%;text-align: center;background-color: #026AB7; color: white;">Model</th> 
      <th  style="width:5%;text-align: center;background-color: #026AB7; color: white;">Mold ID</th>
            <th style="width:5%;text-align: center;background-color: #026AB7; color: white;">Forecast</th>
            <th style="width:5%;text-align: center;background-color: #026AB7; color: white;"> </th> 
            <th  style="width:5%;text-align: center;background-color: #026AB7; color: white;">Jan</th>
            <th style="width:5%;text-align: center;background-color: #026AB7; color: white;">Feb</th>
            <th style="width:5%;text-align: center;background-color: #026AB7; color: white;">Mar</th>

            <th  style="width:5%;text-align: center;background-color: #026AB7; color: white;">Apr</th>
            <th style="width:5%;text-align: center;background-color: #026AB7; color: white;">May</th>
            <th style="width:5%;text-align: center;background-color: #026AB7; color: white;">Jun</th>

            <th  style="width:5%;text-align: center;background-color: #026AB7; color: white;">Jul</th>
            <th style="width:5%;text-align: center;background-color: #026AB7; color: white;">Aug</th>
            <th style="width:5%;text-align: center;background-color: #026AB7;color: white;">Sep</th>

            <th  style="width:5%;text-align: center;background-color: #026AB7;color: white;">Oct</th>
            <th style="width:5%;text-align: center;background-color: #026AB7;color: white;">Nov</th>
            <th style="width:5%;text-align: center;background-color: #026AB7;color: white;">Dec</th>
            <th  style="width:5%;text-align: center;background-color: #026AB7;color: white;">Sum</th>
            <th style="width:5%;text-align: center;background-color: #026AB7;color: white;">Cost</th>
          <th style="width:5%;text-align: center;background-color: #026AB7;color: white;">Cost</th>
        </tr>
               ...
               foreach($Forecastsettings as $Forecastsetting){
                $count=0; 
                              foreach($mold_settingdata as $mold_settings){ 
                                if($mold_settings->model == $Forecastsetting->mold_item)
                                  {
                                      $count++;  
                                  } 
                               } 
             ...
             <td><?php echo $Forecastsetting->mold_item;?></td>
                        <td><?php echo $Forecastsetting->year;?> </a></td>
                        <td>Forecast</td>
                        <td ><?php echo $a1=$Forecastsetting->jan/$count; ?> </td>
                        <td ><?php echo $a2=$Forecastsetting->feb/$count;?> </td>
                        <td ><?php echo $a3=$Forecastsetting->mar/$count;?> </td>
                        <td ><?php echo $a4=$Forecastsetting->apr/$count;?> </td>
                        <td ><?php echo $a5=$Forecastsetting->may/$count;?> </td>
                        <td ><?php echo $a6=$Forecastsetting->jun/$count;?> </span></td>
                        <td ><?php echo $a7=$Forecastsetting->jul/$count;?> </span></td> 
                        <td ><?php echo $a8=$Forecastsetting->aug/$count;?> </span></td>
                        <td ><?php echo $a9=$Forecastsetting->sep/$count;?> </span></td>
                        <td ><?php echo $a10=$Forecastsetting->oct/$count;?> </span></td>
                        <td ><?php echo $a11=$Forecastsetting->nov/$count;?> </span></td>
                        <td ><?php echo $a12=$Forecastsetting->dec/$count;?> </span></td>
                 ...
                 <?php   foreach($status_mold as $status_mold){
                  ...
                  ?>                               
                         ...
                         <td> </td>
                                              <td> </a></td>
                                              <td>Actual</td>
                                              <td > <?php  echo (round($b1));?>  </td>
                                              <td >  <?php echo (round($b2));?> </td>
                                              <td > <?php  echo (round($b3));?> </td>
                                              <td > <?php echo (round($b4));?>  </td>
                                              <td >  <?php echo (round($b5));?>  </td>
                                              <td > <?php   echo (round($b6));?>  </td>
                                              <td > <?php echo (round($b7));?>  </td> 
                                              <td > <?php echo (round($b8));?>  </td>
                                              <td > <?php echo (round($b9));?> </td>
                                              <td > <?php echo (round($b10));?>  </td>
                                              <td > <?php echo (round($b11));?>  </td>
                                              <td > <?php echo (round($b12));?> </td>
                                              <td ><?php echo $Forecastsetting->sum;?> </span></td>
                                              <td ><?php echo $Forecastsetting->cost;?> </span></td>
                                              <td ><?php echo $Forecastsetting->cost1;?> </span></td> 
                        ...
                        <td> </td>
                                                   <td><?php echo $Forecastsetting->mold;?> </td>
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;
                                                    <a data-toggle="modal" class="open-targetx"   data-mold-item="<?php echo $Forecastsetting->mold_setting_id;?>"  data-x="<?php echo $x;?>"   data-y="<?php echo $y;?>"  ><i class="fa fa-pencil"></i></a>
                                                     </td>
                                                    <td >
                                                      <?php  
                                                    ...
                                                    <td > <?php $c2=$c1+$b2; echo (round($c2));?></td>
                                                    <td ><?php $c3=$c2+$b3; echo (round($c3));?></td>
                                                    <td ><?php $c4=$c3+$b4; echo (round($c4));?></td>
                                                    <td > <?php $c5=$c4+$b5; echo (round($c5));?></td>
                                                    <td > <?php $c6=$c5+$b6; echo (round($c6));?></td>
                                                    <td > <?php $c7=$c6+$b7; echo (round($c7));?></td>
                                                    <td > <?php $c8=$c7+$b8; echo (round($c8));?></td>
                                                    <td > <?php $c9=$c8+$b9; echo (round($c9));?></td>
                                                    <td ><?php $c10=$c9+$b10; echo (round($c10));?></td>
                                                    <td > <?php $c11=$c10+$b11; echo (round($c11));?></td> 
                                                    <td > <?php $c12=$c11+$b12; echo (round($c12));?></td>
                            ...
                            <td> </td>
                                                    <td>Change Box Set</td>
                                                     <td><?php   echo $y;  ?> &nbsp;&nbsp;&nbsp;
                                                    <a data-toggle="modal" class="open-targety"   data-mold-item="<?php echo $Forecastsetting->mold_setting_id;?>"  data-x="<?php echo $x;?>"   data-y="<?php echo $y;?>"  ><i class="fa fa-pencil"></i></a>  </td>
                                                    <td >
                                                    <?php if($Forecastsetting->y=='0'){ $d1=0+$b1; }
                                                        else { $d1=$Forecastsetting->y+$b1;  } 
                                                        echo (round($d1));    ?>
                                                      </td>
                                                    <td >   <?php   $d2=$d1+$b2; echo (round($d2));    ?> </td>
                                                    <td ><?php $d3=$d2+$b3; echo (round($d3));?></td>
                                                    <td ><?php $d4=$d3+$b4; echo (round($d4));?></td>
                                                    <td > <?php $d5=$d4+$b5; echo (round($d5));?></td>
                                                    <td > <?php $d6=$d5+$b6; echo (round($d6));?></td>
                                                    <td > <?php $d7=$d6+$b7; echo (round($d7));?></td>
                                                    <td > <?php $d8=$d7+$b8; echo (round($d8));?></td>
                                                    <td > <?php $d9=$d8+$b9; echo (round($d9));?></td>
                                                    <td ><?php $d10=$d9+$b10; echo (round($d10));?></td>
                                                    <td > <?php $d11=$d10+$b11; echo (round($d11));?></td> 
                                                    <td > <?php $d12=$d11+$b12; echo (round($d12));?></td>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-4" > Mold item:<br>
...
<?php $this->load->helper('form');?>
 ...
 <input type="hidden" name="y" id="y"  > 
   <input class="btn btn-primary  button button2" name="saveX" type="submit" value="Save">
  </div>
</div> 
 <?php echo form_close(); ?>
</div>
...
<?php $this->load->helper('form');?>
 ...
 <input type="text" name="y" id="y1"  > 
   <input class="btn btn-primary  button button2" name="saveY" type="submit" value="Save">
  </div>
</div> 
 <?php echo form_close(); ?>
</div>
